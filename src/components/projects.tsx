    ...
    return (
        <section className="py-20">
            <div className="flex items-center justify-center rounded-full bg-purple-700/5 px-3 py-1 mb-24 w-fit mx-auto border border-purple-300/5 opacity-75">
                <h2
                    className="text-center text-3xl bg-gradient-to-r from-rose-300/50 to-purple-500/80 text-transparent bg-clip-text font-bold rounded px-8 py-4">
                    Projects I Worked
                </h2>
            </div>
            ...
            <div className="flex flex-col gap-20">
                <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                    ...
                    <Image alt="Spotify Profile app homepage" width="200" height="48" className="rounded border-2 border-rose-200/10 transition group-hover:border-rose-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1 h-[150px] object-cover" src="/cover-magnesium.png" />
                </div>
                <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                    <div className="absolute -inset-x-4 -inset-y-4 z-0 hidden rounded-md transition motion-reduce:transition-none lg:-inset-x-6 lg:block lg:group-hover:bg-rose-800/5 lg:group-hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:group-hover:drop-shadow-lg"></div>
                    <div className="z-10 sm:order-2 sm:col-span-6">
