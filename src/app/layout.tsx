  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        <svg className="pointer-events-none absolute isolate" xmlns="http://www.w3.org/2000/svg" width="100%" height="670" viewBox="150 16 1440 670" fill="none">
          <g clip-path="url(#clip0_28_3792)">
            <g opacity="0.4">
              <g opacity="0.6" filter="url(#filter0_f_28_3792)">
                <path d="M1019.8 -54.7218C969.738 -45.9245 930.592 -22.6399 915.048 5.76688C899.949 33.3594 914.623 62.4725 942.43 86.6732C969.963 110.637 1010.75 130.48 1060.99 132.784C1110.15 135.038 1152.95 117.889 1187.49 97.9104C1222.08 77.9096 1252.64 53.2206 1246.68 25.4008C1240.7 -2.44546 1200.51 -22.1997 1158.55 -37.0192C1116.2 -51.9742 1067.44 -63.0931 1019.8 -54.7218Z" fill="url(#paint0_linear_28_3792)" />
              </g>
              <g opacity="0.9" filter="url(#filter1_f_28_3792)">
                <path d="M723.072 -222.412C652.377 -210.959 613.095 -169.156 573.408 -131.725C536.259 -96.6885 499.957 -59.9136 506.777 -18.4126C514.024 25.6754 553.082 65.47 610.312 92.8214C670.407 121.541 745.395 137.489 821.218 131.863C900.468 125.983 980.252 104.023 1021.34 62.3281C1060.46 22.6227 1035.59 -25.8116 1021.42 -71.3088C1007.7 -115.394 998.946 -162.806 942.302 -191.494C882.344 -221.861 798.43 -234.622 723.072 -222.412Z" fill="url(#paint1_linear_28_3792)" />
              </g>
              ...
              <g opacity="0.9" filter="url(#filter3_f_28_3792)">
                <path opacity="0.6" d="M339.407 -97.8941C283.144 -82.8304 230.686 -44.5442 215.869 0.198692C202.316 41.1343 243.67 73.2542 272.136 105.272C291.546 127.108 316.839 144.155 350.313 151.433C380.53 158.002 411.72 147.758 444.101 142.66C494.502 134.727 554.789 146.201 588.692 113.909C625.016 79.3091 622.923 28.7817 602.9 -8.59822C583.808 -44.2388 533.9 -57.5077 488.657 -72.8403C440.945 -89.0083 392.548 -112.123 339.407 -97.8941Z" fill="url(#paint2_linear_28_3792)" />
              </g>
            </g>
          </g>
          <defs>
            <filter id="filter0_f_28_3792" x="769" y="-197.598" width="618.425" height="470.582" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            ...
            <linearGradient id="paint2_linear_28_3792" x1="257.683" y1="40.5617" x2="533.405" y2="17.3635" gradientUnits="userSpaceOnUse">
