...
So I thought if it is valuable to me, it may be available for someone else too. That's why I'm gonna share with you today my personal alias.
...
The first alias you are going to create it's too add items to staged and commit at the same time. For that, I use the letter C. Use the code below to create alias.
