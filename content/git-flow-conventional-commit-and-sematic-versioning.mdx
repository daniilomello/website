...
1. **main** – Has the code ready to be used in production.
2. **develop** – Where continuous development of the application is carried out.
3. **feature** – Used to create new features.
4. **release** – Used to define the delivery of a new pre-production version.
5. **hotfix** – Used to define urgent bugs made in production.
